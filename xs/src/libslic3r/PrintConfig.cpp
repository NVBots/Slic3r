...
PrintConfigDef::PrintConfigDef()
{
    ...
    def->enum_values.push_back("alignedoffsetrectilinear");
    ...
    def->enum_labels.push_back("Aligned Offset Rectilinear");
    ...
    def->enum_labels.push_back("AlignedOffsetRectilinear");
